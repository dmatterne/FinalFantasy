...
public class Character implements Serializable {
  ...
  @ManyToOne
  @JoinColumn(name = "weapon_1_id", referencedColumnName = "id",
    foreignKey = @ForeignKey(name = "char_weapon_1_fk"))
  @Where(clause = "type = 'WEAPON'")
  private UserItem weapon1;

  @ManyToOne
  @JoinColumn(name = "weapon_2_id", referencedColumnName = "item_id",
    foreignKey = @ForeignKey(name = "char_weapon_2_fk"))
  @Where(clause = "type = 'WEAPON'")
  private UserItem weapon2;

  @ManyToOne
  @JoinColumn(name = "weapon_3_id", referencedColumnName = "item_id",
    foreignKey = @ForeignKey(name = "char_weapon_3_fk"))
  @Where(clause = "type = 'WEAPON'")
  private UserItem weapon3;

  @ManyToOne
  @JoinColumn(name = "weapon_4_id", referencedColumnName = "item_id",
    foreignKey = @ForeignKey(name = "char_weapon_4_fk"))
  @Where(clause = "type = 'WEAPON'")
  private UserItem weapon4;

  @ManyToOne
  @JoinColumn(name = "sigil_id", referencedColumnName = "item_id",
    foreignKey = @ForeignKey(name = "char_sigil_fk"))
  @Where(clause = "type = 'SIGIL'")
  ...
  public EquipmentItem getWeapon1() {
    return weapon1;
  }

  public void setWeapon1(EquipmentItem weapon1) {
    this.weapon1 = weapon1;
  }

  public EquipmentItem getWeapon2() {
    return weapon2;
  }

  public void setWeapon2(EquipmentItem weapon2) {
    this.weapon2 = weapon2;
  }

  public EquipmentItem getWeapon3() {
    return weapon3;
  }

  public void setWeapon3(EquipmentItem weapon3) {
    this.weapon3 = weapon3;
  }

  public EquipmentItem getWeapon4() {
    return weapon4;
  }

  public void setWeapon4(EquipmentItem weapon4) {
    this.weapon4 = weapon4;
  }

  public EquipmentItem getSigil() {
    return sigil;
  }

  public void setSigil(EquipmentItem sigil) {
    this.sigil = sigil;
  }
